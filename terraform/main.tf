...
provisioner "remote-exec" {
    inline = [
      ...
      "sudo yes | gcloud auth configure-docker europe-central2-docker.pkg.dev && sudo docker login https://europe-central2-docker.pkg.dev/peppy-web-405812/my-docker"
    ]
